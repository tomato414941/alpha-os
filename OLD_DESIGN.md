...
**Removed.** The managed/deployed/active naming taxonomy was based on the
discrete state machine. Stake-based selection eliminates the need for these
distinctions. See `DESIGN.md`.
