...
def main() -> None:
    ...
    parser.add_argument("--tickets-path", type=Path, default=ROOT / "current_symbol_lane_paper_tickets.csv")
    parser.add_argument("--output-path", type=Path, default=ROOT / "current_symbol_lane_paper_outcomes.csv")
    parser.add_argument("--md-output-path", type=Path, default=ROOT / "current_symbol_lane_paper_outcomes.md")
