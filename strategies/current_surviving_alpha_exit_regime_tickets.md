# Current Surviving Alpha Exit Regime Tickets

These are fresh paper tickets for exit regimes that survived a second-repeat review but failed the tighter path-risk check. They are not live trade instructions.
