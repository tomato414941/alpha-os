...
def main() -> None:
    ...
    parser.add_argument(
        "--tickets-path",
        type=Path,
        default=ROOT / "current_promoted_ticket_repeat_tickets.csv",
    )
    parser.add_argument(
        "--output-path",
        type=Path,
        default=ROOT / "current_promoted_ticket_repeat_outcomes.csv",
    )
    parser.add_argument(
        "--md-output-path",
        type=Path,
        default=ROOT / "current_promoted_ticket_repeat_outcomes.md",
    )
