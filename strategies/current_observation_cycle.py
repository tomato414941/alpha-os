...
DEFAULT_COMMANDS = (
    ...
    ("strategies.stablecoin_liquidity.current_stablecoin_flow_proxy_tickets", "--preserve-opened-at"),
    (
        "strategies.current_promoted_ticket_repeat_outcomes",
        "--tickets-path",
        "strategies/stablecoin_liquidity/current_stablecoin_flow_proxy_tickets.csv",
        "--output-path",
        "strategies/stablecoin_liquidity/current_stablecoin_flow_proxy_outcomes.csv",
        "--md-output-path",
    ...
    ("strategies.protocol_fundamentals.current_protocol_fee_repeat_tickets", "--preserve-opened-at"),
    (
        "strategies.current_promoted_ticket_repeat_outcomes",
        "--tickets-path",
        "strategies/protocol_fundamentals/current_protocol_fee_repeat_tickets.csv",
        "--output-path",
        "strategies/protocol_fundamentals/current_protocol_fee_repeat_outcomes.csv",
        "--md-output-path",
    ...
    ("strategies.token_unlocks.current_token_unlock_event_window_tickets", "--preserve-opened-at"),
    (
        "strategies.current_promoted_ticket_repeat_outcomes",
        "--tickets-path",
        "strategies/token_unlocks/current_token_unlock_event_window_tickets.csv",
        "--output-path",
        "strategies/token_unlocks/current_token_unlock_event_window_outcomes.csv",
        "--md-output-path",
    ...
    ("strategies.token_unlocks.current_token_unlock_event_window_repeat_tickets", "--preserve-opened-at"),
    (
        "strategies.current_promoted_ticket_repeat_outcomes",
        "--tickets-path",
        "strategies/token_unlocks/current_token_unlock_event_window_repeat_tickets.csv",
        "--output-path",
        "strategies/token_unlocks/current_token_unlock_event_window_repeat_outcomes.csv",
        "--md-output-path",
        "strategies/token_unlocks/current_token_unlock_event_window_repeat_outcomes.md",
    ),
    (
        "strategies.token_unlocks.current_token_unlock_event_window_risk_check",
        "--outcomes-path",
        "strategies/token_unlocks/current_token_unlock_event_window_repeat_outcomes.csv",
        "--output-path",
        "strategies/token_unlocks/current_token_unlock_event_window_repeat_risk_check.csv",
        "--md-output-path",
        "strategies/token_unlocks/current_token_unlock_event_window_repeat_risk_check.md",
    ),
    ...
    ("strategies.market_breadth.current_volume_price_dislocation_fill_risk_check",),
    ("strategies.market_breadth.current_volume_price_dislocation_repeat_tickets", "--preserve-opened-at"),
    (
        "strategies.market_breadth.current_volume_price_dislocation_outcomes",
        "--tickets-path",
        "strategies/market_breadth/current_volume_price_dislocation_repeat_tickets.csv",
        "--output-path",
        "strategies/market_breadth/current_volume_price_dislocation_repeat_outcomes.csv",
        "--md-output-path",
        "strategies/market_breadth/current_volume_price_dislocation_repeat_outcomes.md",
    ),
    (
        "strategies.market_breadth.current_volume_price_dislocation_fill_risk_check",
        "--outcomes-path",
        "strategies/market_breadth/current_volume_price_dislocation_repeat_outcomes.csv",
        "--output-path",
        "strategies/market_breadth/current_volume_price_dislocation_repeat_fill_risk_check.csv",
        "--md-output-path",
        "strategies/market_breadth/current_volume_price_dislocation_repeat_fill_risk_check.md",
    ),
    ...
    ("strategies.event_flow.current_ofi_paper_tickets", "--preserve-opened-at"),
    (
        "strategies.current_paper_ticket_outcomes",
        "--tickets-path",
        "strategies/event_flow/current_ofi_paper_tickets.csv",
        "--output-path",
        "strategies/event_flow/current_ofi_paper_outcomes.csv",
        "--md-output-path",
        "strategies/event_flow/current_ofi_paper_outcomes.md",
    ),
    (
        ...
        "strategies/event_flow/current_ofi_paper_outcomes.csv",
        "--output-path",
        "strategies/event_flow/current_ofi_paper_action_queue.csv",
        "--md-output-path",
        "strategies/event_flow/current_ofi_paper_action_queue.md",
    ),
    (
        ...
        "strategies/event_flow/current_ofi_paper_tickets.csv",
        "--output-path",
        "strategies/event_flow/current_ofi_paper_fill_risk_check.csv",
        "--md-output-path",
        "strategies/event_flow/current_ofi_paper_fill_risk_check.md",
    ),
    (
        "strategies.current_broad_alpha_fill_audit_tickets",
        "--fill-risk-path",
        "strategies/event_flow/current_ofi_paper_fill_risk_check.csv",
        "--broad-tickets-path",
        "strategies/event_flow/current_ofi_paper_tickets.csv",
        "--output-path",
        "strategies/event_flow/current_ofi_fill_audit_tickets.csv",
        "--md-output-path",
        "strategies/event_flow/current_ofi_fill_audit_tickets.md",
        "--preserve-opened-at",
    ),
    (
        ...
        "strategies/event_flow/current_ofi_fill_audit_tickets.csv",
        "--output-path",
        "strategies/event_flow/current_ofi_fill_audit_outcomes.csv",
        "--md-output-path",
        "strategies/event_flow/current_ofi_fill_audit_outcomes.md",
    ),
    ("strategies.event_flow.current_ofi_repeat_tickets", "--preserve-opened-at"),
    (
        "strategies.current_paper_ticket_outcomes",
        "--tickets-path",
        "strategies/event_flow/current_ofi_repeat_tickets.csv",
        "--output-path",
        "strategies/event_flow/current_ofi_repeat_outcomes.csv",
        "--md-output-path",
        "strategies/event_flow/current_ofi_repeat_outcomes.md",
    ),
    (
        "strategies.current_paper_ticket_action_queue",
        "--outcomes-path",
        "strategies/event_flow/current_ofi_repeat_outcomes.csv",
        "--output-path",
        "strategies/event_flow/current_ofi_repeat_action_queue.csv",
        "--md-output-path",
        "strategies/event_flow/current_ofi_repeat_action_queue.md",
    ),
    (
        "strategies.current_paper_ticket_fill_risk_check",
        "--action-queue-path",
        ...
        "strategies/event_flow/current_ofi_repeat_tickets.csv",
        "--output-path",
        "strategies/event_flow/current_ofi_repeat_fill_risk_check.csv",
        "--md-output-path",
        "strategies/event_flow/current_ofi_repeat_fill_risk_check.md",
    ),
    (
        "strategies.current_broad_alpha_fill_audit_tickets",
        "--fill-risk-path",
        ...
        "strategies/event_flow/current_ofi_repeat_tickets.csv",
        "--output-path",
        "strategies/event_flow/current_ofi_repeat_fill_audit_tickets.csv",
        "--md-output-path",
        "strategies/event_flow/current_ofi_repeat_fill_audit_tickets.md",
        "--preserve-opened-at",
    ),
    (
        "strategies.current_broad_alpha_fill_audit_outcomes",
        ...
        "strategies/event_flow/current_ofi_repeat_fill_audit_tickets.csv",
        "--output-path",
        "strategies/event_flow/current_ofi_repeat_fill_audit_outcomes.csv",
        "--md-output-path",
        "strategies/event_flow/current_ofi_repeat_fill_audit_outcomes.md",
    ),
    (
        "strategies.event_flow.current_ofi_repeat_tickets",
        "--outcomes-path",
        "strategies/event_flow/current_ofi_repeat_fill_audit_outcomes.csv",
        "--audit-tickets-path",
        "strategies/event_flow/current_ofi_repeat_fill_audit_tickets.csv",
        "--output-path",
        "strategies/event_flow/current_ofi_second_repeat_tickets.csv",
        "--md-output-path",
        "strategies/event_flow/current_ofi_second_repeat_tickets.md",
        "--ticket-prefix",
        "ofi-second-repeat",
        "--preserve-opened-at",
    ),
    (
        ...
        "strategies/event_flow/current_ofi_second_repeat_tickets.csv",
        "--output-path",
        "strategies/event_flow/current_ofi_second_repeat_outcomes.csv",
        "--md-output-path",
        "strategies/event_flow/current_ofi_second_repeat_outcomes.md",
    ),
    (
        "strategies.current_paper_ticket_action_queue",
        "--outcomes-path",
        "strategies/event_flow/current_ofi_second_repeat_outcomes.csv",
        "--output-path",
        "strategies/event_flow/current_ofi_second_repeat_action_queue.csv",
        "--md-output-path",
        "strategies/event_flow/current_ofi_second_repeat_action_queue.md",
    ),
    (
        "strategies.current_paper_ticket_fill_risk_check",
        "--action-queue-path",
        ...
        "strategies/event_flow/current_ofi_second_repeat_tickets.csv",
        "--output-path",
        "strategies/event_flow/current_ofi_second_repeat_fill_risk_check.csv",
        "--md-output-path",
    ...
    ("strategies.prediction_markets.current_event_probability_execution_queue", "--preserve-opened-at"),
    ...
    ("strategies.crypto_pair_spread.current_crypto_pair_spread_repeat_tickets", "--preserve-opened-at"),
    (
        "strategies.crypto_pair_spread.current_crypto_pair_spread_outcomes",
        "--tickets-path",
        "strategies/crypto_pair_spread/current_crypto_pair_spread_repeat_tickets.csv",
        "--output-path",
        "strategies/crypto_pair_spread/current_crypto_pair_spread_repeat_outcomes.csv",
        "--md-output-path",
        "strategies/crypto_pair_spread/current_crypto_pair_spread_repeat_outcomes.md",
    ),
    (
        "strategies.crypto_pair_spread.current_crypto_pair_spread_fill_risk_check",
        "--outcomes-path",
        ...
        "strategies/crypto_pair_spread/current_crypto_pair_spread_repeat_tickets.csv",
        "--output-path",
        "strategies/crypto_pair_spread/current_crypto_pair_spread_repeat_fill_risk_check.csv",
        "--md-output-path",
        "strategies/crypto_pair_spread/current_crypto_pair_spread_repeat_fill_risk_check.md",
    ),
    ...
    ("strategies.current_broad_alpha_paper_tickets", "--preserve-opened-at"),
    ("strategies.current_broad_alpha_paper_outcomes",),
    (
        "strategies.current_paper_ticket_action_queue",
        "--outcomes-path",
        "strategies/current_broad_alpha_paper_outcomes.csv",
        "--output-path",
        "strategies/current_broad_alpha_paper_action_queue.csv",
        "--md-output-path",
        "strategies/current_broad_alpha_paper_action_queue.md",
    ),
    (
        "strategies.current_paper_ticket_fill_risk_check",
        "--action-queue-path",
        "strategies/current_broad_alpha_paper_action_queue.csv",
        "--tickets-path",
        "strategies/current_broad_alpha_paper_tickets.csv",
        "--output-path",
        "strategies/current_broad_alpha_paper_fill_risk_check.csv",
        "--md-output-path",
    ...
    ("strategies.current_broad_alpha_fill_audit_outcomes",),
    ("strategies.current_broad_alpha_repeat_tickets", "--preserve-opened-at"),
    (
        "strategies.current_paper_ticket_outcomes",
        "--tickets-path",
        "strategies/current_broad_alpha_repeat_tickets.csv",
        "--output-path",
        "strategies/current_broad_alpha_repeat_outcomes.csv",
        "--md-output-path",
        "strategies/current_broad_alpha_repeat_outcomes.md",
    ),
    (
        "strategies.current_paper_ticket_action_queue",
        "--outcomes-path",
        "strategies/current_broad_alpha_repeat_outcomes.csv",
        "--output-path",
        "strategies/current_broad_alpha_repeat_action_queue.csv",
        "--md-output-path",
        "strategies/current_broad_alpha_repeat_action_queue.md",
    ),
    (
        "strategies.current_paper_ticket_fill_risk_check",
        "--action-queue-path",
        ...
        "strategies/current_broad_alpha_repeat_tickets.csv",
        "--output-path",
        "strategies/current_broad_alpha_repeat_fill_risk_check.csv",
        "--md-output-path",
        "strategies/current_broad_alpha_repeat_fill_risk_check.md",
    ),
    (
        "strategies.current_broad_alpha_fill_audit_tickets",
        "--fill-risk-path",
        ...
        "strategies/current_broad_alpha_repeat_tickets.csv",
        "--output-path",
        "strategies/current_broad_alpha_repeat_fill_audit_tickets.csv",
        "--md-output-path",
        "strategies/current_broad_alpha_repeat_fill_audit_tickets.md",
        "--preserve-opened-at",
    ),
    (
        "strategies.current_broad_alpha_fill_audit_outcomes",
        ...
        "strategies/current_broad_alpha_repeat_fill_audit_tickets.csv",
        "--output-path",
        "strategies/current_broad_alpha_repeat_fill_audit_outcomes.csv",
        "--md-output-path",
        "strategies/current_broad_alpha_repeat_fill_audit_outcomes.md",
    ),
    ...
    ("strategies.current_alpha_conflict_resolution_progress",),
    ...
    (
        "strategies.current_promoted_ticket_repeat_outcomes",
        "--tickets-path",
        "strategies/current_portable_microstructure_horizon_tickets.csv",
        "--output-path",
        "strategies/current_portable_microstructure_horizon_outcomes.csv",
        "--md-output-path",
        "strategies/current_portable_microstructure_horizon_outcomes.md",
    ),
