# Current Stablecoin Flow Proxy Tickets

These are paper labels for chain-liquidity proxy candidates. They are not direct exchange stablecoin inflow signals and not trade instructions.

| ticket | rank | asset | side | venue | entry | checkpoints | next step |
| --- | ---: | --- | --- | --- | ---: | --- | --- |
