...
def _symbols_for_stack_row(row: dict[str, str]) -> tuple[str, ...]:
    ...
    if row.get("status") in {
        ...
        "live_taker_intraday_probe",
        "live_low_fee_intraday_probe",
        "intraday_live_feature_source_blocked",
        "intraday_live_execution_blocked",
        "low_cost_intraday_paper_supported",
        "intraday_paper_supported",
        "low_cost_intraday_paper_recent_only",
        "intraday_paper_positive_mean_watch",
        "intraday_paper_watch",
