...
| UNI | confirmed_long_cluster | 117.2838 | 2 | 3 | L=3, S=0, RV=0, Y=0, R=0, N=0 | long | uni_fee_growth_price_context, uni_fee_yield_valuation, uni_protocol_fee_growth | paper-label UNI long setup against forward return, costs, depth, and failure regime |
...
| CRV | confirmed_long_cluster | 112.9020 | 2 | 2 | L=2, S=0, RV=0, Y=0, R=0, N=0 | long | crv_fee_growth_price_context, crv_fee_yield_valuation | paper-label CRV long setup against forward return, costs, depth, and failure regime |
...
| PENDLE | multi_source_watch | 103.4146 | 2 | 1 | L=1, S=0, RV=0, Y=0, R=0, N=0 | long | pendle_fee_growth_price_context | collect more PENDLE snapshots before treating this as a cluster |
