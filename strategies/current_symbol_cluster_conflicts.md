...
| JTO | mixed_structure_conflict | 118.0063 | 4 | 3 | L=1, S=0, RV=1, Y=0, R=0, N=1 | mixed | jto_l2_imbalance_probe, jto_volume_price_dislocation, jto_okx_liquidation_continuation | split JTO labels by lane before trading; do not collapse conflicting ideas into one action |
