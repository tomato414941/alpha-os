...
| ETH | mixed_structure_conflict | 125.7968 | 6 | 9 | L=1, S=0, RV=5, Y=0, R=0, N=3 | relative_value | eth-12jun26_basis, eth-26mar27_basis, eth_calendar_spread_20260612, eth_institutional_flow_news_event, okx_eth_chain_flow_context | split ETH labels by lane before trading; do not collapse conflicting ideas into one action |
...
| SOL | mixed_direction_conflict | 115.1172 | 3 | 6 | L=2, S=2, RV=0, Y=0, R=2, N=0 | mixed | solana_stablecoin_migration, coinup.io_(futures)_sol-usdt_positioning, kucoin_futures_solusdtm_positioning, solana_bountywork_sol_dex_pool, solana_boutywork_sol_dex_pool | split SOL labels by lane before trading; do not collapse conflicting ideas into one action |
| ZEC | mixed_direction_conflict | 112.3110 | 3 | 5 | L=1, S=1, RV=2, Y=0, R=0, N=1 | relative_value | whitebit_futures_zec_perp_positioning, zec_institutional_flow_news_event, zec_security_risk_news_event, zec_attention_funding_overlap, zec_protocol_activity_context | split ZEC labels by lane before trading; do not collapse conflicting ideas into one action |
...
| JUP | confirmed_long_cluster | 97.4515 | 1 | 2 | L=2, S=0, RV=0, Y=0, R=0, N=0 | long | jup_fee_yield_valuation, jup_protocol_fee_growth | paper-label JUP long setup against forward return, costs, depth, and failure regime |
| AAVE | confirmed_long_cluster | 97.1448 | 1 | 2 | L=2, S=0, RV=0, Y=0, R=0, N=0 | long | aave_fee_yield_valuation, aave_protocol_fee_growth | paper-label AAVE long setup against forward return, costs, depth, and failure regime |
| UNI | confirmed_long_cluster | 96.3234 | 1 | 2 | L=2, S=0, RV=0, Y=0, R=0, N=0 | long | uni_fee_yield_valuation, uni_protocol_fee_growth | paper-label UNI long setup against forward return, costs, depth, and failure regime |
...
| MORPHO | confirmed_long_cluster | 94.3282 | 1 | 2 | L=2, S=0, RV=0, Y=0, R=0, N=0 | long | morpho_fee_yield_valuation, morpho_protocol_fee_growth | paper-label MORPHO long setup against forward return, costs, depth, and failure regime |
...
| CRV | single_candidate_watch | 87.0660 | 1 | 1 | L=1, S=0, RV=0, Y=0, R=0, N=0 | long | crv_fee_yield_valuation | collect more CRV snapshots before treating this as a cluster |
...
| USDT0 | single_candidate_watch | 77.5484 | 1 | 1 | L=0, S=0, RV=0, Y=1, R=0, N=0 | yield | plasma_fluid-lending_usdt0_yield | collect more USDT0 snapshots before treating this as a cluster |
| AVANT | single_candidate_watch | 77.4891 | 1 | 1 | L=0, S=0, RV=0, Y=1, R=0, N=0 | yield | avalanche_avant-avusd_savusd_yield | collect more AVANT snapshots before treating this as a cluster |
| AVUSD | single_candidate_watch | 77.4891 | 1 | 1 | L=0, S=0, RV=0, Y=1, R=0, N=0 | yield | avalanche_avant-avusd_savusd_yield | collect more AVUSD snapshots before treating this as a cluster |
| SAVUSD | single_candidate_watch | 77.4891 | 1 | 1 | L=0, S=0, RV=0, Y=1, R=0, N=0 | yield | avalanche_avant-avusd_savusd_yield | collect more SAVUSD snapshots before treating this as a cluster |
