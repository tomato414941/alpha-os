...
| ZRO | confirmed_short_cluster | 124.0000 | 3 | 2 | L=0, S=2, RV=0, Y=0, R=0, N=0 | short | zro_validated_perp_crowding_reversion, zro_unlock_event | paper-label ZRO short setup against forward return, costs, depth, and failure regime |
...
| ETHFI | multi_source_watch | 110.5000 | 2 | 1 | L=0, S=1, RV=0, Y=0, R=0, N=0 | short | ethfi_validated_perp_crowding_reversion | collect more ETHFI snapshots before treating this as a cluster |
