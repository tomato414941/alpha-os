...
| public_hypertracker_example | ETH | watch_wallet_long_pressure | 79 | 6903.69 | 436.91 | 22.33 | 414.58 | 2.796600 | 60.93 | label public_hypertracker_example/ETH wallet-flow pressure over 15m/1h/4h, then compare against market-wide flow and execution costs |
| public_hypertracker_example | ZEC | watch_wallet_long_pressure | 40 | 49.59 | 449.71 | 5.95 | 443.76 | 1.320000 | 49.02 | label public_hypertracker_example/ZEC wallet-flow pressure over 15m/1h/4h, then compare against market-wide flow and execution costs |
...
| public_live_bot_example | SOL | watch_wallet_long_pressure | 195 | 34.55 | 4.69 | 2.15 | 2.54 | 0.590000 | 19.83 | label public_live_bot_example/SOL wallet-flow pressure over 15m/1h/4h, then compare against market-wide flow and execution costs |
...
| public_hypertracker_example | APT | watch_wallet_long_pressure | 37 | 1196.41 | 6.95 | 3.65 | 3.30 | 534.630000 | 5.57 | label public_hypertracker_example/APT wallet-flow pressure over 15m/1h/4h, then compare against market-wide flow and execution costs |
