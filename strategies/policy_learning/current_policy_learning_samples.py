...
OUTCOME_PATHS = (
    ...
    ("ofi_second_repeat", ROOT / "event_flow" / "current_ofi_second_repeat_outcomes.csv"),
...
FILL_RISK_PATHS = (
    ...
    ROOT / "event_flow" / "current_ofi_repeat_fill_risk_check.csv",
    ROOT / "event_flow" / "current_ofi_second_repeat_fill_risk_check.csv",
