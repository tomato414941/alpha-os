...
| --- | --- | --- | --- | --- |
| crypto_market_structure | execution_gate_candidate | spot_perp_positive_funding_top_1_14d: low_slippage_maker_like headroom=3.918648bps, default_sharpe=2.5059113109 | actual account fees, borrow/margin, and book-depth feasibility remain shallow | validate venue-specific fees, margin, and symbol availability before paper trading |
