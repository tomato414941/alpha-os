...
| candidate_validation | current_return_context | WLD: single_source_momentum_context, sources=cross_exchange_funding, 1h=0.10535542, 4h=0.17126664 | recent return context is not forward-labeled alpha evidence | label candidate signals from their timestamps and compare against neutral baselines |
