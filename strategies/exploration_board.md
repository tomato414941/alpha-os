...
| perp_market_map | current_carry_reversion_screen | MON: long_carry_reversion_watch, funding=-0.73946576, mark_oracle=-0.001966216820, score=14.82154683 | current crowding proxy is not yet joined to future returns or execution costs | monitor top carry/reversion rows and label subsequent returns, funding decay, and liquidation risk |
