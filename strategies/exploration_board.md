...
| prediction_markets | short_window_microstructure_monitor | information_flow_watch: HSBC Championships, Qualification: Storm Hunter vs Aliaksandra Sasnovich, obs=5, score=22.61383334, spread=0.010000 | event probability and adverse selection are not modeled | join top markets to external event models and CLOB depth checks |
