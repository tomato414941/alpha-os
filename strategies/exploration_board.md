...
| prediction_markets | current_microstructure_screen | information_flow_watch: HSBC Championships, Qualification: Storm Hunter vs Aliaksandra Sasnovich, spread=0.010000, change=0.675000, vol24=238892.477685 | event probability is not modeled; this only ranks active public market structure | join top markets to external event models, order books, and adverse-selection checks |
