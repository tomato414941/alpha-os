...
METHOD_RULES = (
    MethodRule(
        ...
        missing_link="maker fill probability, queue position, cancellation, adverse selection, and horizon-specific reward",
        first_probe="turn the LOB policy-survival rows into a tiny maker-fill paper policy with queue and adverse-selection labels",
    ...
    MethodRule(
        ...
        research_reference="https://arxiv.org/search/?query=limit+order+book+transformer+trading&searchtype=all",
        base_priority=112.0,
    ),
    MethodRule(
        ...
        research_reference="https://arxiv.org/abs/2404.19109",
        base_priority=110.0,
    ),
    MethodRule(
