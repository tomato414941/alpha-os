...
METHOD_RULES = (
    MethodRule(
        ...
        missing_link="book replay, queue/fill approximation, adverse selection, and reward after fees",
        first_probe="build a tiny market-vs-limit-vs-hold replay on one BTC/ETH bookDepth plus aggTrade sample",
