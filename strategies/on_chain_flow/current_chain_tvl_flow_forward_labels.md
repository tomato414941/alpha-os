# Current Chain TVL Flow Forward Labels

This labels tradable chain TVL flow candidates against subsequent token returns. Positive directional return means the action-specific direction was right before costs.
