...
| --- | --- | --- | --- |
| spot/perp carry | funding received after hedging spot and perp price moves | spot, perp, funding, fees, margin, depth | Binance spot/perp carry execution gate exists; 14-day low-turnover family is current candidate |
