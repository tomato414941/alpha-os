...
`universe_policy` was removed from `SubjectSet`; it should not be reintroduced
as a generic policy/spec object. See
[`universe-policy-naming-boundary.md`](./closed/universe-policy-naming-boundary.md).
