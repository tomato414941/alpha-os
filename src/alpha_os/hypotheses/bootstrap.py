...
def bootstrap_hypotheses(asset: str = "BTC") -> list[HypothesisRecord]:
    asset = str(asset).upper()
    if asset == "BTC":
        return _technical_hypotheses() + _ml_hypotheses() + _serious_hypotheses(asset)
    return _serious_hypotheses(asset)
