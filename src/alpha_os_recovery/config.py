...
class RiskConfig:
    ...
    def to_manager_config(self):
        ...
        from alpha_os_recovery.risk.manager import RiskManagerConfig
...
class AlphaGeneratorConfig:
    ...
    min_feature_catalog_size: int = 100
...
class Config:
    ...
    def to_monitor_config(self):
        ...
        from alpha_os_recovery.hypotheses.monitor import MonitorConfig
